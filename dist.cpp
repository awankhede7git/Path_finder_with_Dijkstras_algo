...
// Function to print the shortest distance and path from source to destination
...
// Function to implement Dijkstra's algorithm for a given adjacency matrix graph
